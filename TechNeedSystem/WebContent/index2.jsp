        ...
        <div id="mainFrame">
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="no" width="100%" height="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/accorditionIndex2.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="auto" width="100%" height="100%" frameBorder=0 id=frmright name=frmright src="rightPages/xtjs.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="fbox">
                <div id="bs_footcenter">
                    <div id="bs_footleft">
                        <div id="bs_footright">
                            河北省重大技术需求征集系统 业务咨询：0311-85813216 技术服务：（咨询王老师）
                        </div>
                    </div>
                </div>
            </div>
