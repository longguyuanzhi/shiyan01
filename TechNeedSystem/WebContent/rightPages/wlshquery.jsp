      ...
      // System.out.println(submit);
       if(submit==null||submit=="")
       {
   		...
   		while(rs.next())
   		{
   			...
   			<td><%=i %></td>
   			<td>
			<%if(rs.getString(6).equals("2")) out.print("<a href='wlshshow.jsp?id="+id+"'>"+rs.getString(2)+"</a>");
       ...
       else
       {
        ...
        {
        	sql="select id,needname,Organname,LocationArea,organattr,states from needtable where states='2'";
        }
