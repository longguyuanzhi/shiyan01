...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>注册-河北省重大技术需求征集问卷调查系统</title>
        <!--框架必需start-->
                            ...
                            <div id="lbox_middlecenter">
                                <div id="lbox_middleleft">
                                    <div id="lbox_middleright">
                                        <div id="bs_left">
                                            <IFRAME scrolling="no" width="100%" height="100%" frameBorder=0 id=frmleft name=frmleft src="leftPages/accorditionRegister.html" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                            ...
                            <div id="rbox_middlecenter">
                                <div id="rbox_middleleft">
                                    <div id="rbox_middleright">
                                        <div id="bs_right">
                                            <IFRAME scrolling="auto" width="100%" height="100%" frameBorder=0 id=frmright name=frmright src="rightPages/zhuce.jsp" allowTransparency="true">
                                            </IFRAME>
                                        </div>
                                    </div>
                                </div>
